export const opinions = [
    ...
    "Not everyone should aim to be a doctor, engineer, or any highly successful career. People can shoot for lower things without being lazy or failures, but don't expect to be respected for it. ",
    ...
    'I used to do this as a child and one day I suddenly started having trouble breathing. Thanks Nutella! Now I eat it with a spoon and an epi pen in hand. ',
